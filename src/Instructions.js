...
var Instructions = cc.Layer.extend({
    sheetTexture: null,
    menu: null,
    cloudLeft: null,
    cloudRight: null,
    ...
    init:function () {
        ...
        if (this._super()) {
            ...
            console.log('4');
            this.titleLabel = cc.LabelTTF.create('Instructions', 'font1', 90);
            ...
            var tmpLabel = cc.LabelTTF.create('Goto A,\nClick on B,\nTake C,\nYou Win', 'arial', 32, cc.SizeMake(400, 300), cc.TEXT_ALIGNMENT_CENTER);
...
Instructions.scene = function () {
    var scene = cc.Scene.create();
    var layer = Instructions.create();
